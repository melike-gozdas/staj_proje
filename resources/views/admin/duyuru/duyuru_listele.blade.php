              ...
              <div class="card-body table-responsive p-0">
                <table border="1" class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row" style="text-align: center;">{{$duyuru->id}}</th>
                      <td style="text-align: center;">{{$duyuru->baslik}}</td>
                      <td style="text-align: center;">{{$duyuru->updated_at}}</td>
                      <td style="text-align: center;">{!!$duyuru->durum ==0 ? "<span class='text-danger'>Pasif </span>" : "<span class='text-success'>Aktif </span>" !!}</td>
                      <td style="text-align: center;">
                        <a href="{{route('duyuru_duzenle',$duyuru->id)}}" title="Düzenle" class="btn btn-sm btn-primary"><i class='fa fa-pen'></i></a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content bg-danger">
                              ...
                              <div class="modal-footer justify-content-between">
                                ...
                                <a href="{{route('duyuru_sil',$duyuru->id)}}" type="button" class="btn btn-outline-light">Sil</a>
                              </div>
                            </div>
                            <!-- /.modal-content -->
                          </div>
