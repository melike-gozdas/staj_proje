...
@section('title', 'Grup '. (isset($grup) ? 'Düzenle' : 'Ekle'))
@section('css')
...
@endsection
@section('PageAdı')
Gruplar {{(isset($grup) ? 'Düzenle' : 'Ekle')}}
@endsection
@section('content')
<form action="/alt-baslik-kaydet" method="post">
	@csrf
	<div class="card card-outline card-info">
		<div class="card-header">
			<div class="form-group">
			<select name="Kategoriler" id="">
				@foreach($kategoriler as $kategoribasliklar)
				<option value="{{$kategoribasliklar->id}}">{{$kategoribasliklar->adi}}</option>
