...
@section('PageAdı', 'Alt Başlık')

@section('content')

<form action="{{route('alt-baslik-kaydet')}}" method="post">
  @csrf
    ...
    <div class="form-group">
      ...
      <div class="card">
        <div class="card-body row">
          ...
          <div class="col-7">
            ...
            <div class="form-group">
                <input type="text" name="kategori_id" hidden value="{{$kategori->id}}">
              <label for="inputName">Kategori Adı</label>
              <input type="text" name="adi" id="inputName" class="form-control" value= "{{$kategori->adi}}" />
            </div>
      ...
      <div class="card card-outline card-info">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <textarea id="summernote" name="sayfaIcerik" value="{{$proje->pYazisi ?? ''}}" >{{$proje->pYazisi ?? ''}}
