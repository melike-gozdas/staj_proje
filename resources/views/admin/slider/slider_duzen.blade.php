...
@section('title', 'Slider '.(isset($haber) ? 'Düzenleme': 'Ekleme'))
@section('css')
...
@endsection
@section('PageAdı')
Slider {{isset($slider) ? 'Düzenleme' : 'Ekleme'}}
@endsection
@section('content')
<form action="{{route('slider_kaydet')}}" method="post" enctype="multipart/form-data">
	@csrf
	<div class="card card-outline card-info">
		<div class="card-header">
			<div class="form-group">
				...
				-->
				<div class="row">
					<input type="text" name="baslik" class="form-control col-md-10" placeholder="Slider başlığını yazınız..." style="left:15px;" value="{{$slider->baslik ?? ''}}" max="200" min="3">
					<div class="form-check"  style="left:50px;">
						@if(isset($slider->durum))
						<input name="durum" class="form-check-input" type="checkbox" value="{{$slider->durum}}"
						@if($slider->durum) checked @endif >
						@else
						<input name="durum" class="form-check-input" type="checkbox">
						@endif
		...
		<div class="card-body">
			<div class="col-lg-4">
				<input type="file" class="form-control" name="image" value="{{$slider->resim ?? ''}}">
				<br>
				@if(isset($slider->resim))
				<img src="{{$slider->resim}}" width="300">
				@endif
			</div>
			<br>
			<!--
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<div class="input-group date" id="reservationdatetime" data-target-input="nearest">
								<input name="haber_tarih" type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" value=""/>
						...
						<div class="modal-dialog">
							<div class="modal-content bg-success">
								<div class="modal-header">
									<h4 class="modal-title">Slider Kaydedilecek</h4>
