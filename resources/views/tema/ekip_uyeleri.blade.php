...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <h1 class="display-6 mb-5">Ekip Üyeleri</h1>
        </div>
        <div class="row g-4" style="margin-left: 250px;">
            <!--
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5>Adı Soyadı</h5>
                        <span class="text-primary">Recep Ali AY</span>
                    </div>
                </div>
            </div>
        -->
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5>Adı Soyadı</h5>
                        <span class="text-primary">İrem Nur MERMER</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5>Adı Soyadı</h5>
                        <span class="text-primary">Kadriye GÜNDÜZ</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5>Adı Soyadı</h5>
                        <span class="text-primary">Melike GÖZDAŞ</span>
                    </div>
                </div>
            </div>
        </div>
