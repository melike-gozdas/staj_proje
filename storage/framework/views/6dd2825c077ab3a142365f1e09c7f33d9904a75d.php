<?php $__env->startSection('title', 'Kategori '. (isset($kategor) ? 'Düzenle' : 'Ekle')); ?>
...
Kategori <?php echo e((isset($kategor) ? 'Düzenle' : 'Ekle')); ?>
	...
	<div class="card card-outline card-info">
		<div class="card-header">
			<div class="form-group">
				...
				<input type="text" hidden name="id" value="<?php echo e(isset($kategori) ? $kategori->id : 'yeni'); ?>">

				<div class="row">
					<input type="text" name="adi" class="form-control col-md-10" placeholder="Kategori adını giriniz" style="left:15px;" value="<?php echo e($kategori->adi ?? ''); ?>">
				</div>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/melike/kbb-satj/resources/views/admin/pages/kategori_form.blade.php ENDPATH**/ ?>