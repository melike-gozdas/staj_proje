            ...
            <div class="col-lg-8 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item">
                    ...
                    <div class="d-flex align-items-center bg-light">
                        ...
                        <a class="h4 mx-4 mb-0" href="#">Haberler</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item">
                    ...
                    <div class="d-flex align-items-center bg-light">
                        ...
                        <a class="h4 mx-4 mb-0" href="#">Duyurular</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item">
                    ...
                    <div class="d-flex align-items-center bg-light">
                        ...
                        <a class="h4 mx-4 mb-0" href="#">Projeler</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Service End --><?php /**PATH /home/melike/kbb-satj/resources/views/tema/hizmetler.blade.php ENDPATH**/ ?>