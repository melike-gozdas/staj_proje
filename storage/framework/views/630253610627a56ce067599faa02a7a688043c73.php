<?php $__env->startSection('title', 'Haber '.(isset($haber) ? 'Düzenleme': 'Ekleme')); ?>
...
Haber <?php echo e(isset($haber) ? 'Düzenleme' : 'Ekleme'); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<form action="<?php echo e(route('haber_kaydet')); ?>" method="post" enctype="multipart/form-data">
	<?php echo csrf_field(); ?>
	<div class="card card-outline card-info">
		<div class="card-header">
			<div class="form-group">
				...
				-->
				<div class="row">
					<input type="text" name="haber_baslik" class="form-control col-md-10" placeholder="Haber başlığını yazınız..." style="left:15px;" value="<?php echo e($haber->baslik ?? ''); ?>" max="200" min="3">
					<div class="form-check"  style="left:50px;">
						<?php if(isset($haber->durum)): ?>
						<input name="haber_durum" class="form-check-input" type="checkbox" value="<?php echo e($haber->durum); ?>"
						<?php if($haber->durum): ?> checked <?php endif; ?> >
		...
		<div class="card-body">
			<div class="col-lg-4">
				<input type="file" class="form-control" name="image" value="<?php echo e($haber->resim ?? ''); ?>">
				<br>
				<?php if(isset($haber->resim)): ?>
				<img src="<?php echo e($haber->resim); ?>" width="300">
				<?php endif; ?>
			</div>
			<br>
			<div class="col-lg-10">
				<textarea id="summernote" name="haber_metni" value="<?php echo e($haber->icerik ?? ''); ?>">
				<?php if(isset($haber->icerik)): ?>
				<?php echo e($haber->icerik); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/melike/kbb-satj/resources/views/admin/haber/haber_duzen.blade.php ENDPATH**/ ?>