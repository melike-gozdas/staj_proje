...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link href="/assets/tema/img/favicon.ico" rel="icon">
        <!-- Google Web Fonts -->
        ...
        <link href="/assets/tema/lib/animate/animate.min.css" rel="stylesheet">
        <link href="/assets/tema/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
        <!-- Customized Bootstrap Stylesheet -->
        <link href="/assets/tema/css/bootstrap.min.css" rel="stylesheet">
        <!-- Template Stylesheet -->
        <link href="/assets/tema/css/style.css" rel="stylesheet">
    ...
    <body>
        ...
        -->
        <!-- Navbar End -->
        <?php echo $__env->make('tema.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <script src="/assets/tema/lib/wow/wow.min.js"></script>
        <script src="/assets/tema/lib/easing/easing.min.js"></script>
        <script src="/assets/tema/lib/waypoints/waypoints.min.js"></script>
        <script src="/assets/tema/lib/owlcarousel/owl.carousel.min.js"></script>
        <script src="/assets/tema/lib/counterup/counterup.min.js"></script>
        <script src="/assets/tema/lib/parallax/parallax.min.js"></script>
        <!-- Template Javascript -->
        <script src="/assets/tema/js/main.js"></script>
        <?php echo $__env->yieldContent('js'); ?>
    </body>
</html><?php /**PATH /home/melike/kbb-satj/resources/views/tema/master.blade.php ENDPATH**/ ?>