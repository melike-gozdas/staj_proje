              ...
              <div class="card-body table-responsive p-0">
                <table border="1" class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row" style="text-align: center;"><?php echo e($slider->id); ?></th>
                      <td style="text-align: center;"><?php echo e($slider->baslik); ?></td>
                      <td style="text-align: center;"><img src="<?php echo e($slider->resim); ?>" width="50" height="45"></td>
                      <td style="text-align: center;"><?php echo e($slider->updated_at); ?></td>
                      <td style="text-align: center;"><?php echo $slider->durum ==0 ? "<span class='text-danger'>Pasif </span>" : "<span class='text-success'>Aktif </span>"; ?></td>
                      <td style="text-align: center;">
                        <a href="<?php echo e(route('slider_duzenle',$slider->id)); ?>" title="Düzenle" class="btn btn-sm btn-primary"><i class='fa fa-pen'></i></a>
                        <!--
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content bg-danger">
                              ...
                              <div class="modal-footer justify-content-between">
                                ...
                                <a href="<?php echo e(route('slider_sil',$slider->id)); ?>" type="button" class="btn btn-outline-light">Sil</a>
                              </div>
                            </div>
                          </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/melike/kbb-satj/resources/views/admin/slider/slider_listele.blade.php ENDPATH**/ ?>