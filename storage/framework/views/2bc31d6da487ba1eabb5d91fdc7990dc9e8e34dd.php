...
-->
    <!-- Carousel End -->
    <?php echo $__env->make('tema.slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
-->
    <!-- About End -->
    <?php echo $__env->make('tema.about', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
-->
    ...
    <?php echo $__env->make('tema.listeleme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
-->
    <!-- Service End -->
    <!-- Proje, haber, duyuru sayfalarına yönlendirme-->
...
-->
    <!-- Quote End -->
    <!-- Kayıt işlemi için kulllanılabilir-->
...
-->
    <!-- Team End -->
    <!-- Projeyi yapanlardan bahsedilebilir ya da kaldırılabilir-->
    <?php echo $__env->make('tema.ekip_uyeleri', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
-->
    <!-- Testimonial End -->
    <!-- Müşteri görüşleri için kullanılabilir-->
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('tema.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/melike/kbb-satj/resources/views/tema/anasayfa.blade.php ENDPATH**/ ?>